...
export const projects: Project[] = [
  ...
  {
    id: "owl-events",
    title: "Owl Events - All in One Event Management Platform",
    description:
    ...
    categories: ["frontend"],
    role: "Frontend Developer & Optimize Performance",
    problemStatement:
